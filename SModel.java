...
public class SModel {
    ...
    public boolean isLDloggedin(String name, String pass){
        PreparedStatement p3 = null;
        ResultSet r3 = null;
        String sq4 = "select * from LDtable where Name = ? and Password = ?";
        try{
            p3 = this.connects.prepareStatement(sq4);
            p3.setString(1, name);
            p3.setString(2, pass);
            r3 = p3.executeQuery();
            if (r3.next()) {
            ...
            return false;
        }catch(SQLException ld){return false;}
        finally {
            if (r3 != null) {
                try {
                    r3.close();
    ...
    //for purchaser
    public boolean isPurLoggedin(String name, String pass){
        PreparedStatement p2 = null;
        ResultSet r2 = null;
        String sq3 = "select * from purTable where Name = ? and Password = ?";
        try{
            p2 = this.connects.prepareStatement(sq3);
            p2.setString(1, name);
            p2.setString(2, pass);
            r2 = p2.executeQuery();
