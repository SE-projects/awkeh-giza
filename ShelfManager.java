...
public class ShelfManager extends Frame implements ActionListener {
    ...
    {    
        ...
        Btn[1]  = new JButton("Approval");
        Btn[1].setBounds(50,100,95,30);
        Btn[2]  = new JButton("Update Shellf");
        Btn[2].setBounds(50,100,95,30);
        Btn[3]  = new JButton("Update Isle");
