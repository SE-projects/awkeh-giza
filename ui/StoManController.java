        ...
        try{
            ...
            stg.close();
               Stage stg1 = new Stage();
                ...
                Pane root1 = (Pane) load1.load(getClass().getResource("/ui/SMainPage.fxml").openStream());
                SMcontroller SM1 = (SMcontroller)load1.getController();

                Scene sc2 = new Scene(root1);
                stg1.setScene(sc2);
                stg1.setTitle("Welcome to Awkeh-Giza " + ((Branch)this.comboBranch.getValue()).toString() + " Branch Mr." + this.nameField.getText());
